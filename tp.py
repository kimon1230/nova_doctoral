...
def load_data(path='tp_data.json', num_words=None, skip_top=0, maxlen=None, 
...
def get_word_index(path='tp_data.json', text_choice="review_text_preprocessed_noemoji"):
    """
